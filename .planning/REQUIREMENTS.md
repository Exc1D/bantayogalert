...
- [ ] **AUTH-02**: User can sign in and maintain a session across page reloads
- [ ] **AUTH-03**: User can sign out from any page
- [ ] **AUTH-04**: User roles (citizen, municipal_admin, provincial_superadmin) are stored as Firebase Auth custom claims
...
| REPO-01–05 | Phase 3 | Pending |
| FEED-01–05 | Phase 4 | Pending |
| WORK-01–10 | Phase 6 | Pending |
| CONT-01–04 | Phase 7 | Pending |
| ALRT-01–08 | Phase 8 | Pending |
| PROF-01–04 | Phase 9 | Pending |
| MAP-01–07 | Phase 4 | Pending |
| MOBI-01–06 | Phase 5 | Pending |
| SEC-01–06 | Phase 2 + ongoing | Pending |
| A11Y-01–05 | Phase 11 | Pending |
| SEO-01–03 | Phase 11 | Pending |
| OBS-01–03 | Phase 6 + ongoing | Pending |
