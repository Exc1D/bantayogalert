...
import { registerWithEmail, loginWithGoogle } from '../../../lib/auth/operations'
...
export function RegisterPage() {
  ...
  async function handleGoogleRegister() {
    ...
    try {
      // For Google registration, we still create a Firestore user doc
      // The loginWithGoogle already signs in, but we may need to create the user doc
      // For now, treat it as login (user doc should already exist if they registered before)
      ...
      <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
        <div className="mb-6 text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Join Bantayog Alert to report emergencies in Camarines Norte
          </p>
        </div>
