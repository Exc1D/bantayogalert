...
exports.triageVerify = functions.https.onCall(async (data, context) => {
    ...
    await db.runTransaction(async (tx) => {
        ...
        tx.update(db.collection('report_private').doc(reportId), {
            ownerStatus: status_1.WORKFLOW_TO_OWNER_STATUS[report_1.WorkflowState.Verified],
